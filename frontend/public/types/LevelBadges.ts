...
export interface LevelBadgesInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "claim"
      | "hasClaimed"
...
export interface LevelBadges extends BaseContract {
  connect(runner?: ContractRunner | null): LevelBadges;
  waitForDeployment(): Promise<this>;

  interface: LevelBadgesInterface;
